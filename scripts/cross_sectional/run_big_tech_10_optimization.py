...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Optimize V7 financial and technical selection inside a fixed "
            "Big Tech 10 universe."
        )
    )
...
def main() -> None:
    ...
    artifacts = run_big_tech_10_optimization(
        paths,
    ...
    print(f"Individual buy-and-hold: {artifacts.individual_buy_hold_csv}")
